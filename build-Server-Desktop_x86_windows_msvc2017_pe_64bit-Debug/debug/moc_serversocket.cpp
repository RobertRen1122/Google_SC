...
QT_MOC_LITERAL(15, 179, 15), // "messageRecieved"
QT_MOC_LITERAL(16, 195, 8), // "reciever"
QT_MOC_LITERAL(17, 204, 7), // "message"
QT_MOC_LITERAL(18, 212, 11) // "onReadyRead"
    ...
    "messageRecieved\0reciever\0message\0"
    "onReadyRead"
};
...
void ServerSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->messageRecieved((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QHash<QString,QString>(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ServerSocket::*)(const QString & , QHash<QString,QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerSocket::messageRecieved)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void ServerSocket::messageRecieved(const QString & _t1, QHash<QString,QString> & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
